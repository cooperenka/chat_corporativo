...
function showEditNameModal(username, displayName) {
    ...
    modalContent.innerHTML = `
        <div class="p-6">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input 
                        ...
                        onkeypress="if(event.key==='Enter') submitEditName('${escapeHtml(username)}')"
                    >
                </div>
            </div>
            <div class="flex gap-3 mt-6">
                ...
                <button onclick="submitEditName('${escapeHtml(username)}')" class="flex-1 px-4 py-2.5 bg-green-600 hover:bg-green-700 text-white rounded-lg transition-colors font-medium">
                    Guardar nombre
                </button>
            </div>
        </div>
    ...
    setTimeout(() => document.getElementById('modalNewDisplayName')?.focus(), 100);
}

async function submitEditName(username) {
