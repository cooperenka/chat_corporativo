                ...
                <div class="flex items-center gap-3">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="text-xs truncate ${unread > 0 ? 'text-indigo-600 font-semibold' : 'text-gray-500'}">
                            ${unread > 0 ? `💬 ${unread} mensaje${unread > 1 ? 's' : ''} nuevo${unread > 1 ? 's' : ''}` : `${group.memberCount} miembro${group.memberCount !== 1 ? 's' : ''}${group.description ? ' · ' + escapeHtml(group.description.substring(0, 20)) : ''}`}
                        </div>
                    </div>
                </div>
            </button>
