...
class ChatHandler(BaseHTTPRequestHandler):
    ...
    def _register(self):
        ...
        try:
            ...
            with data_lock:
                ...
                save_users()
                # Agregar automáticamente a todos los grupos existentes
                add_user_to_all_groups(username)
                ...
                contacts_list = [
                    {
                        ...
                        'online': (
                            ...
                            now - active_users[user['username']]['lastSeen'] < 15
                        )
                    }
    ...
    def _admin_create_group(self):
        ...
        try:
            ...
            add_all = post_data.get('addAllUsers', True)  # Por defecto agrega a todos
